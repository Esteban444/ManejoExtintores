...
namespace ManejoExtintores.Core.Servicios 
{
    public class ServicioGasto : IServicioGasto
    {
        ...
        public async Task<Gasto> GetGasto(int id)
        {
            ...
            {
                throw new Excepcion_Servidor("El registro de gasto no existe en la base de datos");
            }
        }
        ...
        public async Task<bool> ActualizarGasto(Gasto gasto) 
        {
            ...
            {
                throw new Excepcion_Servidor("El registro de gasto que desea actualizar no existe en la base de datos"); 
            }
        }
        ...
        public async Task<bool> EliminarGasto(int id)
        {
            ...
            {
                throw new Excepcion_Servidor("El gasto no existe en la base de datos");
            }
        }
    }
}
