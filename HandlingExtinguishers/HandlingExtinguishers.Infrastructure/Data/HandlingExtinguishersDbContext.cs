...
namespace HandlingExtinguishers.Infrastructure.Data
{
    public class HandlingExtinguishersDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<InventoryTable>().Property(e => e.TypeExtinguisherId).HasConversion<string>();
            modelBuilder.Entity<InventoryTable>().Property(e => e.WeightExtinguisherId).HasConversion<string>();
            ...
            modelBuilder.Entity<ProductTable>().Property(e => e.TypeExtinguisherId).HasConversion<string>();
            modelBuilder.Entity<ProductTable>().Property(e => e.WeightExtinguisherId).HasConversion<string>();
            modelBuilder.Entity<ProductTable>().Property(e => e.PriceId).HasConversion<string>();

            modelBuilder.Entity<ServiceTable>().Property(e => e.Id).HasConversion<string>();
            modelBuilder.Entity<ServiceTable>().Property(e => e.ClientId).HasConversion<string>();
            modelBuilder.Entity<ServiceTable>().Property(e => e.EmployeeId).HasConversion<string>();
